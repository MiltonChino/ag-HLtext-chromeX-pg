(function () {
    ...
    if (document.getElementById('text-highlighter-sidebar-host')) {
        const host = document.getElementById('text-highlighter-sidebar-host');
    ...
    :host {
      ...
      width: 300px; /* Mobile friendly width could be 100% or smaller */
      height: 100vh;
  ...
  `;
    ...
    function saveHighlights() {
        // Use localStorage for bookmarklet
        localStorage.setItem('highlights_' + window.location.hostname, JSON.stringify(highlights));
    }

    function loadHighlights() {
        const stored = localStorage.getItem('highlights_' + window.location.hostname);
        if (stored) {
    ...
    const highlightBtn = sidebar.querySelector('#highlight-btn');
    ...
    highlightBtn.addEventListener('click', () => {
        ...
        if (selection.rangeCount > 0 && !selection.isCollapsed) {
            ...
            addHighlight(selection.toString(), range);
